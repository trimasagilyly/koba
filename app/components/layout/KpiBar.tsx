import { BASE_POINT, SIM_SYMBOLS, SIM_STOCKS } from "../../utils/stockData";
import { GINI_ZONE_MID } from "../../constants/simulation";
  ...
  return (
    <div className="bg-slate-900 border-b border-slate-900 px-4 py-2 flex gap-5 shrink-0 flex-wrap">
      ...
      <div className="min-w-28">
        ...
        <div
          className={`text-xs mt-0.5 ${gini > GINI_ZONE_MID ? "text-red-400" : "text-emerald-400"}`}
        >
          {gini > GINI_ZONE_MID ? "⚠ Bất bình đẳng cao" : "✓ Ổn định"}
        </div>
      </div>
